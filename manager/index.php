    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><b>Sistem Penggajian - Manager</b></a>
            </div>
            <!-- /.navbar-header -->
...
<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       <li>
									<a href="?modul=absensi"><span class="icon-navigasi"><img src="../libs/images/icon-absensi.png" class=""/></span> Absensi</a>
								</li>
								<li>
									<a href="?modul=libur"><span class="icon-navigasi"><img src="../libs/images/icon-libur.png" class=""/></span> Libur</a>
								</li>
								<li>
								...
								<li>
									<a href="?modul=salary"><span class="icon-navigasi"><img src="../libs/images/icon-salary.png" class=""/></span> Salary</a>
								</li>
								<li>
									<a href="?modul=pinjaman"><span class="icon-navigasi"><img src="../libs/images/icon-loan.png" class=""/></span> Pinjaman</a>
								</li>
								<li>
									<a href="?modul=klaim"><span class="icon-navigasi"><img src="../libs/images/icon-klaim.png" class=""/></span> Klaim</a>
								</li>								
								<li>
									<a href="?modul=kenaikkan"><span class="icon-navigasi"><img src="../libs/images/icon-kenaikkan.png" class=""/></span>Kenaikkan </a>
								</li>      
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
