...
?>
<form method="POST" action="../controller/doUpdateSalary.php" class="form-horizontal">
...
<input type='submit' value='Simpan' class='btn btn-primary'>   <a class='btn btn-danger' onclick='javascript:history.back()'>Kembali</a>";
}
?>
</form>
<!-- INSERT DATABASE -->