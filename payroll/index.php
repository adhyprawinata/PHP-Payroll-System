    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><b>Sistem Penggajian - Finance</b></a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
					...
					<h2>Menu Finance</h2>
						...
						<ul class="nav" id="side-menu">
							<li>
								<a href="?modul=klaim"><span class="icon-navigasi"><img src="../libs/images/icon-klaim.png" class=""/></span> Klaim</a>
							</li>
							<li>
								
								<a href="#"><span class="icon-navigasi"><img src="../libs/images/icon-salary.png" class=""/></span><span class="fa arrow" style="top:11px;position:relative;"></span>Salary</a>
								<ul class="nav nav-second-level collapse" aria-expanded="false">
									<li><a href="?modul=salary">Manage Salary</a></li>
									<li><a href="?modul=inputSalaryNonReguler">Staff Non-Reguler</a></li>
								</ul>
							</li>
							<li>
								<a href="#"><span class="icon-navigasi"><img src="../libs/images/icon-loan.png" class=""/></span><span class="fa arrow" style="top:11px;position:relative;"></span>Pinjaman</a>
									<ul class="nav nav-second-level collapse" aria-expanded="false">
										<li><a href="?modul=pinjaman">Pinjaman</a></li>
										<li><a href="?modul=cicilan">Cicilan</a></li>
									</ul>
							</li>							
						</ul>
						</div>
                     ...
                     <div class="col-lg-12">
                        <h1 class="page-header"><?php 
							if($modul != ""){
								...
								}elseif($modul == "inputSalaryNonReguler"){
									$judul = "Salary Karyawan Non-Reguler";
...
<?php	
	...
	case "karyawanCicilan" :
		include "../employee/mod_cicilan/cicilan.php";
	break;
	case "inputSalaryNonReguler" :
		include "mod_salary/salaryNonReguler.php";
	break;
	case "notifikasi" :
