...
<div class="form-group"><label class="col-sm-3">
	...
	<?php
	if($data_karyawan['id_divisi'] == 3 && $data_karyawan['Level'] == 3){ //Jika Kadiv Finance
		if($data['level'] == 3){ // Request dari kadiv lain
...
<?php
 $sql_message = mysqli_query($k,"SELECT * FROM message WHERE id_klaim = '$id'");
