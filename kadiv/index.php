...
if(isset($_SESSION['login']) && $_SESSION['login'] == true){
	...
	$data_karyawan = mysqli_fetch_assoc($hasil2);
?>
<!DOCTYPE html>
<html lang="en">
...
<?php
	...
	if($data_karyawan['Level'] == 3 && $data_karyawan['id_divisi'] == 3){ //Kadiv Finance
		$sql_notifikasi1 = mysqli_query($k,"SELECT * FROM notifikasi WHERE divisi = '3' AND isRead = 'n'"); 
		...
		$sql_notifikasi1 = mysqli_query($k,"SELECT * FROM notifikasi WHERE divisi = '2' AND isRead = 'n'"); 
		$sql_notifikasi2 = mysqli_query($k,"SELECT * FROM notifikasi WHERE id_penerima = '$id_karyawan' AND isRead = 'n'");	
	}elseif($data_karyawan['Level'] == 3){
		$sql_notifikasi1 = mysqli_query($k,"SELECT * FROM notifikasi WHERE divisi = '$data_karyawan[id_divisi]' AND isRead = 'n'"); 
		$sql_notifikasi2 = mysqli_query($k,"SELECT * FROM notifikasi WHERE id_penerima = '$id_karyawan' AND isRead = 'n'");	
	}
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><b>Sistem Penggajian - Kepala Divisi</b></a>
            </div>
            <!-- /.navbar-header -->

            <ul class="nav navbar-top-links navbar-right">
				<?php echo "Selamat siang, Pak/Bu ".$data_karyawan['Nama'];?>
                
                <!-- /.dropdown -->
                  <li class="dropdown" onclick="notif()">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-bell fa-fw"></i> 
							<i id="cekNotif"><?php echo mysqli_num_rows($sql_notifikasi1)+mysqli_num_rows($sql_notifikasi2); ?></i>
                ...
                <div class="sidebar-nav navbar-collapse">
					...
					<h2>Menu Ka.Div</h2>
						...
						<ul class="nav" id="side-menu">
							<li>
								<a href="#"><span class="icon-navigasi"><img src="../libs/images/icon-absensi.png" class=""/></span><span class="fa arrow" style="top:11px;position:relative;"></span>Absensi</a>
								<ul class="nav nav-second-level collapse" aria-expanded="false">
									<li><a href="?modul=absensi">View Absensi</a></li>
									<li><a href="?modul=uploadAbsensi">Upload Absensi</a></li>
								</ul>
							</li>
							<li>
								<a href="?modul=cuti"><span class="icon-navigasi"><img src="../libs/images/icon-cuti.png" class=""/></span></i> Cuti</a>
							</li>
							<li>
								<a href="?modul=lembur"><span class="icon-navigasi"><img src="../libs/images/icon-lembur.png" class=""/></span> Lembur</a>
							</li>	
							<li>
								<a href="?modul=penilaian"><span class="icon-navigasi"><img src="../libs/images/icon-penilaian.png" class=""/></span> Penilaian</a>
							</li>								
						</ul>
						</div>
					<h2>Menu Karyawan</h2>
						<div class="isi">
							<ul class="nav" id="side-menu">
								...
								<li>
									<a href="?modul=karyawanPinjaman"><span class="icon-navigasi"><img src="../libs/images/icon-loan.png" class=""/></span> Pinjaman</a>
								</li>
								<li>
                        ...
                        <h1 class="page-header"><?php 
							if($modul != ""){
								if($modul == "kenaikkan"){
									...
									$judul = "User Profile";
								}elseif($modul == "uploadAbsensi"){
									$judul = "Upload File Absensi";
								}elseif($modul == "absensi"){
									$judul = "Absensi";
								}
...
<?php	
	...
	case "penilaian" :
		include "mod_penilaian/penilaian.php";
	...
	break;
		case "uploadAbsensi" :
			include "mod_absensi/uploadFile.php";
		break;
		
	case "karyawanAbsensi" :
		include "../employee/mod_absensi/absensi.php";
	break;
	case "karyawanKlaim" :
		include "../employee/mod_klaim/klaim.php";
	break;
	case "karyawanPinjaman" :
		include "../employee/mod_pinjaman/pinjaman.php";
	break;
	case "karyawanSalary" :
		include "../employee/mod_salary/salary.php";
	break;
	case "karyawanKenaikkan" :
		include "../employee/mod_kenaikkan/kenaikkan.php";
	break;
	case "karyawanCuti" :
		include "../employee/mod_cuti/Cuti.php";
	break;
	case "karyawanLembur" :
		include "../employee/mod_lembur/Lembur.php";
	break;
	case "karyawanLibur" :
		include "../employee/mod_libur/libur.php";
	break;
	case "notifikasi" :
