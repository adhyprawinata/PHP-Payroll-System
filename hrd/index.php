...
<?php
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#accordion .isi').hide();
			$('#accordion h2').addClass('aktif').next().slideDown(300);
			$('#accordion h2').click(function(){			
				if($(this).hasClass('aktif')){
					$(this).removeClass('aktif').next().slideUp(300);
				}else{
					$(this).addClass('aktif').next().slideDown(300);
				}
			});
		});
	</script>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><b>Sistem Penggajian - HRD</b></a>
            </div>
            <!-- /.navbar-header -->

            <ul class="nav navbar-top-links navbar-right">
				<?php echo "Selamat siang, Pak/Bu ".$nama['Nama'];?>
                ...
                <div class="sidebar-nav navbar-collapse">
					...
					<h2>Menu HRD</h2>
						...
						<ul class="nav in" id="side-menu">
							...
							<li>
								<a href="?modul=cuti"><span class="icon-navigasi"><img src="../libs/images/icon-cuti.png" class=""/></span> Cuti</a>
							</li>
							<li>
								<a href="?modul=lembur"><span class="icon-navigasi"><img src="../libs/images/icon-lembur.png" class=""/></span> Lembur</a>
							</li>
							<li>
								<a href="?modul=user"><span class="icon-navigasi"><img src="../libs/images/icon-user.png" class=""/></span> User</a>
							</li>
